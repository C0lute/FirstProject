...
echo '<form method="POST" action="show_project_Kopis.php">'; 
echo '<label>Краткое описание</label>'; 
echo '<input type="text" name="Kopis"></input>'; 
echo '<button type="submit">Найти</button>'; 
$nameKopis=$_POST['Kopis']; 
echo '<br>Вы ввели:'; 
echo $nameKopis; 
...
$query = "Select *  FROM `project`, `city` WHERE `город` = `id_города` and `краткое_описание` LIKE '".$nameKopis."%'"; 
