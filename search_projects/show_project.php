...
echo '<form method="POST" action="show_project.php">'; 
echo '<label>Город</label>'; 
echo '<input type="text" name="City"></input>'; 
...
$query = "Select *  FROM `project`, `city` WHERE `город` = `id_города` and `название` LIKE '".$nameCity."%'";
