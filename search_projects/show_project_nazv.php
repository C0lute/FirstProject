...
echo '<form method="POST" action="show_project_nazv.php">'; 
echo '<label>Проект</label>'; 
echo '<input type="text" name="Proekt"></input>'; 
echo '<button type="submit">Найти</button>'; 
echo '</form>'; 
$nameProekt=$_POST['Proekt']; 
echo 'Вы ввели:'; 
echo $nameProekt; 
...
$query = "Select *  FROM `project`, `city` WHERE `город` = `id_города` and  `название_проекта` LIKE '".$nameProekt."%'"; 
